...
async function getBotReply(input) {
  ...
  const casualReplies = {
    ...
    "thank you": "Anytime! Enjoy your meal 🍽️",
    ...
    "Fizz": "I recommend a fizz level of 50% for the perfect balance!",
    "syrup": "Maple syrup is a classic choice!",
    "butter": "A pat of butter makes everything better.",
    "chocolate": "Chocolate chips are a delicious topping!",
    "waffles": "nah",
    "french toast": "nah",
  };
